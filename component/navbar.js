let navbar=()=>{
  ...
  <body>
      ...
      <div>
          <div class="dropdown">
            <button class="dropbtn">Live Scores
          ...
          <div class="dropdown">
            ...
            <div class="dropdown">
              <button class="dropbtn1">Features
                <i class="fa fa-caret-down"></i>
              </button>
              <div class="dropdown-content1">
                <a href="../../fw18_0494/Featurs/index.html">Feature Home</a>
                <a href="#">Writers</a>
            ...
            <div class="dropdown">
              <button class="dropbtn2">Videos
                <i class="fa fa-caret-down"></i>
              </button>
              <div class="dropdown-content2">
                  <div>
                <a href="../../fw18_0494/Video/video.html">Videos Home</a>
      ...
      <div class="navbar-right">
         <div class="fantasy"><a><img src="https://wassets.hscicdn.com/static/images/fantasy-home.png"/><p>Fantasy</p></a></div>
         <div class="dropdown">
