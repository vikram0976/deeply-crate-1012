...
document.getElementById('night').addEventListener('click',function(){
  ...
  document.getElementById('night').innerHTML=null
    ...
    img.innerHTML=`<svg width="35px" style="color:white"height="35px" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-brightness-high">
